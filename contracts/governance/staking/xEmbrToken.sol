...
/**
 * @title xEmbrToken
 * @notice xEmbrToken is a non-transferrable ERC20 token that has both a raw balance and a scaled balance.
 ...
 **/
abstract contract xEmbrToken is
    ILockedERC20,
    Initializable,
    ContextUpgradeable,
    HeadlessStakingRewards
{
    ...
    ****************************************/
    ...
    constructor(
        ...
        bool _hasPriceCoeff
    ) HeadlessStakingRewards(_fulcrum, _rewardsToken) {
